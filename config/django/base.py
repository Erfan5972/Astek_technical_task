...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://astek_user:asktek_123@127.0.0.1:5432/astek_technical_task'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'astek_technical_task.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'astek_technical_task.api.exception_handlers.hacksoft_proposed_exception_handler',
